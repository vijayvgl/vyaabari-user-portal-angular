...
export class FormValidations {
    ...
    */
    ...
    static CaptchaMatch(controlPath: string, matchingControlPath: string): ValidatorFn {
        return (formGroup: AbstractControl): ValidationErrors | null => {
            ...
            // Delete the mustMatch error to reset the error on the matching control
            if (matchingControl.hasError('matchCaptcha')) {
                delete matchingControl.errors.matchCaptcha;
                matchingControl.updateValueAndValidity();
            }
            ...
            // Prepare the validation errors
            const errors = { matchCaptcha: true };
