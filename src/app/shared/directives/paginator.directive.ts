import {
  ...
  export class StylePaginatorDirective {
          ...
          for (let i = 0; i < nodeArray.length; i++) {
            if (nodeArray[i].nodeName === "BUTTON") {
              if (nodeArray[i].innerHTML.length > 100 && nodeArray[i].disabled) {
                ...
                this.ren.setStyle(nodeArray[i], "color", "#00011938");
                this.ren.setStyle(nodeArray[i], "margin", ".5%");
              } else if (nodeArray[i].disabled) {
                this.ren.setStyle(nodeArray[i], "background-color",  "#0033A1");
              }
            }
          }
        });
    ...
    private createButton(i: any, pageIndex: number): any {
      ...
      this.ren.setStyle(linkBtn, "margin", "0 1%");
      this.ren.setStyle(linkBtn, "background-color", "rgb(251, 251, 251)");
      this.ren.setStyle(linkBtn, "color", "rgb(0 1 25 / 29%)");
      ...
      switch (i) {
        case pageIndex:
          ...
          this.ren.addClass(linkBtn, "mat-mini-fab-add");
