...
import { FSDocument, FSDocumentElement } from '@tgss/components/fullscreen/fullscreen.types';

@Component({
    selector       : 'tgss-fullscreen',
    templateUrl    : './fullscreen.component.html',
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'tgssFullscreen'
})
export class TgssFullscreenComponent implements OnInit
{
