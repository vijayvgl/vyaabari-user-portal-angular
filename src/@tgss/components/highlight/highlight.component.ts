...
import { TgssHighlightService } from '@tgss/components/highlight/highlight.service';

@Component({
    selector       : 'textarea[tgss-highlight]',
    templateUrl    : './highlight.component.html',
    styleUrls      : ['./highlight.component.scss'],
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'tgssHighlight'
})
export class TgssHighlightComponent implements OnChanges, AfterViewInit
{
    @Input() code: string;
    @Input() lang: string;
    ...
    constructor(
        ...
        private _tgssHighlightService: TgssHighlightService,
    ...
    private _highlightAndInsert(): void
    {
        ...
        this.highlightedCode = this._domSanitizer.sanitize(SecurityContext.HTML, this._tgssHighlightService.highlight(this.code, this.lang));
